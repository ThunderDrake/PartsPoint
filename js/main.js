...
if (window.innerWidth < 769) {
  ...
  _vars__WEBPACK_IMPORTED_MODULE_1__["default"].reviewSlider.classList.remove('swiper');

  _vars__WEBPACK_IMPORTED_MODULE_1__["default"].reviewSlider.querySelector('.review__cards-wrapper').classList.remove('swiper-wrapper');
